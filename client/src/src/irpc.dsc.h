...
#ifndef _H_IRPC_CONF_
#define _H_IRPC_CONF_
...
typedef struct
{
	char	client_ip_str[ 32 + 1 ] ;
	char	cmd_name[ 255 + 1 ] ;
	char	paras[ 511 + 1 ] ;
} IRPC_CONF ;

_WINDLL_FUNC int DSCINIT_IRPC_CONF( IRPC_CONF *pst );

#include "fasterjson.h"

_WINDLL_FUNC int DSCSERIALIZE_JSON_IRPC_CONF( IRPC_CONF *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_IRPC_CONF( IRPC_CONF *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_IRPC_CONF_V( void *pv , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_IRPC_CONF( char *encoding , char *buf , int *p_len , IRPC_CONF *pst );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_IRPC_CONF_V( char *encoding , char *buf , int *p_len , void *pv );
